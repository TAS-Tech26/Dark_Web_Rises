...
function AdminDashboard() {
  ...
  const { adminId, adminDashboard, adminStartGame, logout } = game;
    ...
    <div className="min-h-screen">
      ...
      <main className="relative mx-auto max-w-[1400px] px-6 py-8">
        ...
        <div className="relative">
          ...
          {section === "rounds" && (
            <RoundsSection stats={stats} starting={starting} notice={notice} onStart={startGame} />
          )}
        </div>
      </main>
    </div>
...
function OverviewSection({ stats, starting, notice, onStart }: ControlProps) {
  const cards = [
