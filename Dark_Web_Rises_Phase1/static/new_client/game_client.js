...
const JSONFields = Object.freeze({
    ...
    // of the final standings); PHASE2_URL is only sent when qualified.
    QUALIFIED : "qualified",
                ...
                if (data[JSONFields.AUTHORISED] === Login.ACCEPTED) {
                    ...
                    if (data[JSONFields.TEAM_STATE] === TeamState.PLAYING) {
                        ...
                        if (data[JSONFields.GAME_STATE] === GameState.GAME_RUNNING) {
                            ...
                            if (this.on_game_over) this.on_game_over(data[JSONFields.TEAM_SCORE], data[JSONFields.TEAM_RANK], data[JSONFields.TOP3], data[JSONFields.QUALIFIED], data[JSONFields.PHASE2_URL], data[JSONFields.PHASE2_USERNAME], data[JSONFields.PHASE2_PASSWORD]);
                        }
                    }
                } else if (data[JSONFields.AUTHORISED] === Login.LOCKED) {
